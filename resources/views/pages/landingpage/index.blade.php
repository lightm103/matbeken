...
<body>
    ...
    <nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
        ...
        <div class="container">
            <a class="navbar-brand" href="#"><img src="{{ asset('landingpage/images/matbeken.png') }}" style="width: 150px; height: auto;"></a>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5">
                        <a class="product-item" href="{{ route('checkout',$item->id)}}">
                            ...
                            <span class="icon-cross">
                                <img src="{{ asset('landingpage/images/cart.svg')}}" class="img-fluid">
                            </span>
                        </a>
                    </div>
                    <!-- End Column 1 -->
